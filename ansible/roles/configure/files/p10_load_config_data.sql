...
insert into vendor_name (vendor_name, currency, supplier_node_name, supplier_node_label) values ('xchem_dsip', NULL, 'Xchem','V_XDSIP');
...
insert into vendor_name (vendor_name, currency, supplier_node_name, supplier_node_label) values ('xchem_probe', NULL, 'Xchem','V_XPROB');
