...
Alan Christie January 2020  Initial Version
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser('Vendor Compound Standardiser (Enamine/CS-BB with pricing)')
    ...
    parser.add_argument('vendor_prefix',
                        help='The ChemSpace vendor file prefix,'
                             ' i.e. "December2019". Only files with this prefix'
    ...
    data_files = glob.glob('{}/{}*'.format(args.vendor_dir,
                                              args.vendor_prefix))
